document.addEventListener('DOMContentLoaded', () => {
    ...
    // 6. Video Control Logic
    const video = document.querySelector('.hero-video');
    const controlBtn = document.getElementById('video-control');

    if (video && controlBtn) {
        const muteIcon = `<path d="M11 5L6 9H2v6h4l5 4V5z"></path><line x1="23" y1="9" x2="17" y2="15"></line><line x1="17" y1="9" x2="23" y2="15"></line>`;
        const unmuteIcon = `<path d="M11 5L6 9H2v6h4l5 4V5z"></path><path d="M19.07 4.93a10 10 0 0 1 0 14.14M15.54 8.46a5 5 0 0 1 0 7.07"></path>`;
        ...
        controlBtn.addEventListener('click', () => {
            if (video.muted) {
                video.muted = false;
                controlBtn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${unmuteIcon}</svg>`;
            } else {
                video.muted = true;
                controlBtn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">${muteIcon}</svg>`;
            }
        });
    }
